...
export function FilesTab({
  ...
  // buffer is the same DOM node and the same pending-selection slot the
  // `applyTab` caret restore (further down) and the Format undo restore
  // (further down still) already share.
