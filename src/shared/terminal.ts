 ...
 *
 * FOUR ANSWERS, AND THE SPLIT IS THE POINT (`sources/tmux/spawn.ts`). `ok` is
 ...
 * `unavailable` is vam not having found out, and it carries the reason tmux
 * gave. Collapsing the last one into an empty pane would tell the operator
 * there is nothing to look at on the strength of never having looked.
 */
